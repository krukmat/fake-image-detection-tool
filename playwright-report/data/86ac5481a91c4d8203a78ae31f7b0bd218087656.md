...
- generic [ref=e2]:
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e10]:
      ...
      - textbox "Suspect Image URL:" [active] [ref=e12]: https://via.placeholder.com/400x300/FF0000/FFFFFF.png?text=Test+Image
    - button "Analyze Images" [ref=e13] [cursor=pointer]
  - generic [ref=e14]:
    - heading "Original Image" [level=3] [ref=e16]
    - heading "Suspect Image" [level=3] [ref=e18]
```